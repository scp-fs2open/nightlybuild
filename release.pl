...
Windows:  [url=http://scp.fsmods.net/builds/Launcher55g.zip]Launcher 5.5g[/url] ([url=http://scp.indiegames.us/builds/Launcher55g.zip]Mirror[/url]) ([url=http://www.mediafire.com/?wdvzn7hhhzh418m]Mirror[/url]) Not compatible with Windows 8+, use wxLauncher above
...
[url=http://scp.fsmods.net/builds/WIN/fs2_open_" . $periodversion . ".7z]fs2_open_" . $periodversion . ".7z[/url] ([url=http://scp.indiegames.us/builds/WIN/fs2_open_" . $periodversion . ".7z]Mirror[/url]) ([color=yellow][url=http://scp.fsmods.net/builds/WIN/fs2_open_" . $periodversion . ".md5]MD5[/url][/color])
...
[url=http://scp.fsmods.net/builds/WIN/fs2_open_" . $periodversion . "_AVX.7z]fs2_open_" . $periodversion . "_AVX.7z[/url] ([url=http://scp.indiegames.us/builds/WIN/fs2_open_" . $periodversion . "_AVX.7z]Mirror[/url]) ([color=yellow][url=http://scp.fsmods.net/builds/WIN/fs2_open_" . $periodversion . "_AVX.md5]MD5[/url][/color])
...
[url=http://scp.fsmods.net/builds/WIN/fs2_open_" . $periodversion . "_SSE.7z]fs2_open_" . $periodversion . "_SSE.7z[/url] ([url=http://scp.indiegames.us/builds/WIN/fs2_open_" . $periodversion . "_SSE.7z]Mirror[/url]) ([color=yellow][url=http://scp.fsmods.net/builds/WIN/fs2_open_" . $periodversion . "_SSE.md5]MD5[/url][/color])
[size=8pt]This one is based on the SSE Optimizations from the MSVC Compiler.[/size]

[url=http://scp.fsmods.net/builds/WIN/fs2_open_" . $periodversion . "_NO-SSE.7z]fs2_open_" . $periodversion . "_NO-SSE.7z[/url] ([url=http://scp.indiegames.us/builds/WIN/fs2_open_" . $periodversion . "_NO-SSE.7z]Mirror[/url]) ([color=yellow][url=http://scp.fsmods.net/builds/WIN/fs2_open_" . $periodversion . "_NO-SSE.md5]MD5[/url][/color])
...
[url=http://scp.fsmods.net/builds/OSX/fs2_open_" . $periodversion . ".dmg]fs2_open_" . $periodversion . ".dmg[/url] ([url=http://scp.indiegames.us/builds/OSX/fs2_open_" . $periodversion . ".dmg]Mirror[/url]) ([color=yellow][url=http://scp.fsmods.net/builds/OSX/fs2_open_" . $periodversion . ".md5]MD5[/url][/color])
...
[url=http://scp.fsmods.net/builds/LINUX/fs2_open_" . $periodversion . ".tar.bz2]fs2_open_" . $periodversion . ".tar.bz2[/url] ([url=http://scp.indiegames.us/builds/LINUX/fs2_open_" . $periodversion . ".tar.bz2]Mirror[/url]) ([color=yellow][url=http://scp.fsmods.net/builds/LINUX/fs2_open_" . $periodversion . ".md5]MD5[/url][/color])
...
[url=http://scp.fsmods.net/builds/FREEBSD/fs2_open_" . $periodversion . ".tar.bz2]fs2_open_" . $periodversion . ".tar.bz2[/url] ([url=http://scp.indiegames.us/builds/FREEBSD/fs2_open_" . $periodversion . ".tar.bz2]Mirror[/url]) ([color=yellow][url=http://scp.fsmods.net/builds/FREEBSD/fs2_open_" . $periodversion . ".md5]MD5[/url][/color])

[color=green][size=12pt]Source Code Export[/size][/color] ([color=yellow][url=http://scp.fsmods.net/builds/fs2_open_" . $underscoreversion . "_src.md5]MD5[/url][/color])
[url=http://scp.fsmods.net/builds/fs2_open_" . $underscoreversion . "_src.tgz]fs2_open_" . $underscoreversion . "_src.tgz[/url] ([url=http://scp.indiegames.us/builds/fs2_open_" . $underscoreversion . "_src.tgz]Mirror[/url])
[/hidden]";
