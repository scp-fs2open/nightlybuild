...
[li]A new [tt]-weaponspew[/tt] command-line option for printing MediaVP-style statistics, plus a weapon comparison spreadsheet, to the debug log.[/li]
...
[li]Enhancements to the model code in preparation for cool features in 21.2.[/li]
...
[size=5pt]Previous [url=https://www.hard-light.net/forums/index.php?topic=96226.0]19.0 Release Thread[/url][/size]
