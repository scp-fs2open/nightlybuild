...
[b]We are trying for quarterly releases from now on. Here is the first![/b]

[b]Change log:[/b] (chronologically ordered)
[list]
[li]Added a dynamic action system for more modder control of effects[/li]
[li]Removed fireball limit[/li]
[li]Fixed bomb intercept in multiplayer[/li]
[li]Changed nebula fog distance from a linear to exponential model[/li]
[li]Turrets on moving subobjects enabled[/li]
[li]LZ4 Compression added for game files[/li]
[/list]
